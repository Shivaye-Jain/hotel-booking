...
const FeaturedDestination = () => {
  ...
  return (
    ...
    <Title title='Featured Destination' subTitle='Discover our handpicked selection of exceptional properties around the world, offering unparalleled luxury and unforgettable experiences.'/>
      ...
      <button onClick={()=>{navigate('/rooms'); scrollTo(0, 0)}} className='my-16 px-4 py-2 text-sm font-medium border-gray-300 border rounded bg-white hover:bg-gray-50 transition-all cursor-pointer'>
